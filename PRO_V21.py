...
logo = ("""           \033[0;91m█████████████████████████████████████
           ...
           ▀▄▄▄▀▀▀▄▄▀▄▄▀▄▄▄▄▀▄▄▀▀▀▀▄▀▀▀▄▄▄▄▀▄▄▄▀ 
\033[0;93m──────────────────────────────────────────────────────
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mAuthor   \033[0;91m: \033[0;96mBangsat Militan ☆ Angga™
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mGithub   \033[0;91m: \033[0;96mGithub.com/Bajingan-Z
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mFacebook \033[0;91m: \033[0;96mFacebook.com/PEMUDA.KALEUM""")
...
def ambil_link():
	...
	print logo
	print ("\033[0;93m──────────────────────────────────────────────────────");time.sleep(0.07)
	jalan("\033[0;92mDilarang Menggunakan Akun Facebook Utama...")
	jalan("\033[0;92mWajib Menggunakan Akun Facebook Tumbal ...")
...
def menu():
	...
	print ("\033[0;93m──────────────────────────────────────────────────────");time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m1\033[0;95m} \033[0;93mCrack ID Dari Teman/Publik');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m2\033[0;95m} \033[0;93mCrack ID Dari Like Teman/Publik');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m3\033[0;95m} \033[0;93mCrack ID Dari Followers');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m4\033[0;95m} \033[0;93mCari ID Menggunakan Username');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m5\033[0;95m} \033[0;93mLihat Hasil Crack');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m6\033[0;95m} \033[0;93mPerbarui Script');time.sleep(0.07)
	print ('\033[0;95m{\033[0;96m0\033[0;95m} \033[0;93mKeluar Akun');time.sleep(0.07)
	print ("\033[0;93m──────────────────────────────────────────────────────");time.sleep(0.07)
	pilih_menu()
